...
var HARDFORK_POS_VERSION = 738197504;
var BLOCK_LIMIT = 200;
...
BlockController.prototype.getPoolInfo = function(block) {
  if ((block.header && block.header.version && block.header.version == HARDFORK_POS_VERSION) || (block.version == HARDFORK_POS_VERSION)) {
    return {
      poolName: 'PoS',
    };
  }
  ...
  for(var k in this.poolStrings) {
    if (coinbaseBuffer.toString('utf-8').match(k)) {
      ...
      var poolInfo = Object.assign({}, this.poolStrings[k]);
      poolInfo.poolName = 'PoW (' + poolInfo.poolName + ')';
